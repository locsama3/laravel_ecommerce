                    ...
                    <div class="panel-body">
                        ...
                        >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea id="short_description" class="form-control" placeholder="Short Description" cols="30" rows="10"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea id="description" class="form-control" placeholder="Description" cols="30" rows="10"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    />
                                    @if($newGallery)
                                        <div wire:loading wire:target="newGallery">Uploading...</div>
