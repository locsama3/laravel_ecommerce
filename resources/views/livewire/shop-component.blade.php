        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title text-uppercase">Shop</h1>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                                        ...
                                        @foreach($category->subCategories as $sub_cate)
                                            <li class="category-item">
                                                <a href="{{route('product.category', [
                                                    ...
                                                    'subcategory_slug' => $sub_cate->slug
                                                ])}}" 
                                                class="cate-link">
                ...
                <div class="widget mercado-widget filter-widget price-filter" style="margin-bottom: 45px;">
                ...
                <div class="widget mercado-widget widget-product">
                    ...
                    <div class="widget-content">
                        <ul class="products">
                            @foreach($popular_products as $p_prod)
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{ route('product.details', ['slug' => $p_prod->slug]) }}" title="{{$p_prod->name}}">
                                            <figure><img src="{{ asset('assets/images/products') }}/{{$p_prod->image}}" alt="{{$p_prod->name}}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $p_prod->slug]) }}" class="product-name"><span>{{$p_prod->name}}</span></a>
                                        <div class="wrap-price"><span class="product-price">${{$p_prod->regular_price}}</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
